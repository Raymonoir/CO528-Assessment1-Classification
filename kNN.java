...
public class kNN {
  public static void main(String[] args) throws IOException {
    System.out.println(
        "These are instructions of how to solve the problems. Please make sure you follow the instructions carefully.");
    System.out.println(
        "Use this function to obtain the optimal k value and then include this k value in the kNN_test.java file. ");
